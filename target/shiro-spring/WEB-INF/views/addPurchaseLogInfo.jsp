...
<div class="Bombbox-info Tab-Module" style="width: 600px;margin: auto">
	<ul class="tab_memu box">
		<li class="boxbox-flex2">
			<a href="javascript:void(0)" class="memu_title btn btn-border clickBombbox selected" data-id="0">发起进货</a>
		</li>

	</ul>
	<div class="tab-box tabcontent">
		<div class="tab-conent prompt_style active">
			<form action="/addPurchaseLog" method="post" id="saveUserInfo">
			...
			<div class="buttonstyle ">
				<button  type="submit" title="发起进货" class="btn padding10 bg-deep-blue ">发起进货</button>
			</div>
			</form>
		</div>
	</div>
